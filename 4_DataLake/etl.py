...
def process_song_data(spark, input_data, output_data):
    ...
    artists_table = df.select("artist_id","artist_name","artist_location","artist_latitude","artist_logitude").drop_duplicates()

    # write artists table to parquet files
    artists_table.write.paraquet(output_data + "artists/", mode="overwrite")
...
def process_log_data(spark, input_data, output_data):
    ...
    get_timestamp = udf(lambda x: datatime.utcfromtimestamp(int(x)/1000), TimestampType())
